...
const renderLeaderboard = (currentUserEmail) => {
    ...
    const sortedCompanies = [...companies].sort((a, b) => b.creditScore - a.creditScore);

    return (
      <div className="bg-white  rounded-xl shadow-sm overflow-hidden">
        <div className="p-6 border-b">
          <h4 className="text-lg text-black/80 flex font-semibold">Top Performers</h4>
        </div>
              ...
              <div className="flex items-center space-x-20">
                ...
                <span
                  className={`font-medium ${
                    company.email === currentUserEmail ? "text-green-600" : ""
                  }`}
                >
                  {company.name}
                </span>
              </div>
              <span className="font-semibold">{company.creditScore}</span>
            </div>
          ))}
        </div>
      </div>
...
//   if (!userDetails) {
//     return (
//       <div className="min-h-screen bg-gradient-to-tr from-blue-600/50 via-blue-200  to-white  flex items-center justify-center z-1">
...
//   const renderHeader = () => (
//     <div className="bg-blue/50 border-white border-2 backdrop-blur-lg z-11 rounded-xl shadow-sm p-6 mb-2 ">
//       <div className="flex">
...
//           <div className="mb-1">
//             <h1 className="text-2xl font-bold mt-7 mb-2 flex">
...
//                       : "bg-white text-gray-600 hover:bg-gray-400/20"
//                   }`}
//                 >
//                   {tab.label}
//                 </button>
...
//     <div  className=" flex overflow-hidden  min-h-screen  p-6">
//        {/* <img
//         src={profilebg}
//         alt="Profile Background"
//         className="absolute bottom-0 left-0 w-2/5 h-auto object-cover rounded-tl-xl"
//         // style={{ transform: "translateY(30%)" }}
//       /> */}
//       <div className="max-w-7xl mx-auto ">
//         <div className="flex items-center space-x-4 mb-8 ">
//           <button
//             onClick={() => navigate("/companiesDB")}
//             className="p-2 hover:bg-gray-400/50 rounded-full transition-colors"
//           >
        ...
        <div className={`text-xl ml-3 font-bold ${stat.textColor}`}>{stat.value}</div>
            ...
            {userDetails?.certificate || (
              <div className="p-6 rounded-xl bg-gray-50/50 backdrop-blur-sm border border-white/50">
                <h3 className="text-lg font-semibold text-gray-800 flex mb-4">Company Certificates</h3>
    ...
    <div className="min-h-screen ">
      <div className="max-w-7xl mx-auto p-6 space-y-6">
        <div className="flex items-center space-x-4">
          <button
            onClick={() => window.location.href = "/companiesDB"}
